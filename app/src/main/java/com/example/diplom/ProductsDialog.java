            ...
            public void onClick(View v) {
                ...
                try {
                    if (user.getProducts() == null) {
                        String update_products = "INSERT INTO Calculator (Products) VALUES ('" + products_string + "')";
                        user.db.execSQL(update_products);
                        if (user.getTogether()== null) {
                            String update_together = "UPDATE Calculator SET Together = '" + products_string + "' WHERE _id = '" + user.UserID + "'";
